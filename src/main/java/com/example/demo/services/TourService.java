...
//
//        Tour to = tourRepository.getTourById(id);
//    }


//    public List<TourDTO> findAllToursByCountry(String countryName)
//    {
//        Iterable<Tour> tours = tourRepository.findAllByCountry_CountryName(countryName);
//        List<TourDTO> tourDTOS = new LinkedList<>();
//        for (Tour tour : tours) {
//            tourDTOS.add(convertTour(tour));
//        }
